...
const App = (props) => {
  ...
  const Search = () => {
    ...
    const onClick = (e) => { e.preventDefault(); return setShowResults((prev) => !prev) }
    return (
      <div>
        <input className="button1" type="submit" value={showResults ? "HIDE" : "SHOW"} onClick={onClick} />
  ...
  return (
    <div className={classes.root}>
      ...
      />
      <input className="button" type="submit" value="refresh" ref={updateRef} onClick={fetch} />
